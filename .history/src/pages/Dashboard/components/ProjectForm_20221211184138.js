    ...
    return (
        <>
            <Row>
                ...
                <div className="d-flex justify-content-center align-items-center border m-5">
                    <img src={imageCover === undefined ? Image : imageCover} alt="Image cover" width={100} height={200} />
                ...
                <Col md={12}>
                    ...
                    <input label="Upload maximum 3 image" className="form-control" type="file" multiple accept="image/png, image/jpeg, image/jpg" onChange={handleFileEvent} />
                </Col>
