        ...
        <>
            <Row>
                ...
                <Col md={12}>
                    ...
                    <label>Upload maximum 3 images</label>
                    <input className="form-control mt-5" type="file" multiple accept="image/png, image/jpeg, image/jpg" onChange={handleFileEvent} />
                </Col>
